            ...
            <div className="solution-section">
                <div className="esquema">
                    <div className="iconME">
                        <img src="assets/student.png" alt="Student" className="img-icons" />
                    </div>
                    <div className="text">
                    ...
                    <div className="iconUni">
                        <img src="assets/teacher.png" alt="Teacher" className="img-icons" />
                    </div>
                    <div className="row2">

                    </div>
                    <div className="iconEmpresa">
                        <img src="assets/empresa.png" alt="Empresa" className="img-icons" />
                    </div>
                    <div className="text">
